...
doc = """
This app is a replication of mind game (Ting Jiang, 2013), and the version is write-first version.
...
- write_side: write down the side
...
class C(BaseConstants):
    NAME_IN_URL = 'mind_game_write_first'
...
class Player(BasePlayer):
    ...
    write_side = models.IntegerField(label="Please report the chosen side in your mind",
                                choices=[[1, 'Up'], [0, 'Down']],
...
class write_side(Page):
    form_model = 'player'
    form_fields = ['write_side']
...
page_sequence = [instruction, comprehension, choose_side, write_side, roll_dice, report_side, Wait, result_pay, next, complete]
